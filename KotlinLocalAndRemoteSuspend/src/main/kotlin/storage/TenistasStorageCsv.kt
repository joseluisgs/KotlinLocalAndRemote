...
class TenistasStorageCsv : TenistasStorage {
    override suspend fun import(file: File): Result<List<Tenista>, TenistaError.StorageError> =
    ...
    override suspend fun export(file: File, data: List<Tenista>): Result<Int, TenistaError.StorageError> =
        withContext(Dispatchers.IO) {
